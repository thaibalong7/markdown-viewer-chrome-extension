...
- **Kích thước gói / build:** đã tối ưu theo hướng Shiki fine-grained (`@shikijs/langs` + `github-light`/`github-dark`), KaTeX CSS lazy khi bật Math, script `npm run analyze` / `size:report` (xem [`DEV.md`](../../DEV.md))
