...
const HIGH_CONTRAST_LIGHT_THEME_COLORS = {
  ...
  link: '#003b8f',
  linkSoft: '#dceaff',
  panelToggleBg: '#e6e6e6',
  panelToggleText: '#1a1a1a',
  panelToggleBorder: '#333333',
  panelToggleHoverBg: '#d5e5ff',
  panelToggleHoverText: '#002d6b',
  panelToggleShadow: '0 1px 4px rgb(0 0 0 / 24%)',
  panelToggleHoverShadow: '0 2px 7px rgb(0 0 0 / 32%)',
  accent: '#005a3c',
  accentSoft: '#d9f2e7',
  warning: '#704000',
  ...
  toastInfoBg: '#dceaff',
  toastInfoText: '#002d6b',
  toastInfoBorder: '#003b8f',
  toastSuccessBg: '#d9f2e7',
  toastSuccessText: '#00452e',
  toastSuccessBorder: '#005a3c',
  toastWarningBg: '#fff0c2',
  toastWarningText: '#573100',
  toastWarningBorder: '#704000',
  toastErrorBg: '#ffe0e0',
  toastErrorText: '#780000',
  toastErrorBorder: '#9c0000'
}
...
const HIGH_CONTRAST_DARK_THEME_COLORS = {
  ...
  link: '#75baff',
  linkSoft: '#102d4d',
  panelToggleBg: '#242424',
  panelToggleText: '#f5f5f5',
  panelToggleBorder: '#d0d0d0',
  panelToggleHoverBg: '#173f69',
  panelToggleHoverText: '#ffffff',
  panelToggleShadow: '0 1px 5px rgb(0 0 0 / 60%)',
  panelToggleHoverShadow: '0 2px 7px rgb(0 0 0 / 72%)',
  accent: '#70e8b5',
  accentSoft: '#123d2d',
  warning: '#ffd166',
  warningSoft: '#4a3500',
  ...
  tableRowAltBg: '#151515',
  toastInfoBg: '#102d4d',
  toastInfoText: '#cbe5ff',
  toastInfoBorder: '#75baff',
  toastSuccessBg: '#123d2d',
  toastSuccessText: '#baf4d9',
  toastSuccessBorder: '#70e8b5',
  toastWarningBg: '#4a3500',
  toastWarningText: '#ffe7a8',
  toastWarningBorder: '#ffd166',
  toastErrorBg: '#4d1717',
  toastErrorText: '#ffd4d0',
  toastErrorBorder: '#ff8a80'
}
...
export const BUILT_IN_THEMES = {
  ...
  'high-contrast-dark': HIGH_CONTRAST_DARK_THEME_COLORS,
